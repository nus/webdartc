/// VP8 encoder → decoder round-trip exercising the libvpx-bundled
/// decoder backend that `registerVp8Codec` now wires up.
@Tags(['native'])
library;
...
void main() {
  ...
  test('encoder → decoder round-trip: dimensions, format and frame count '
      'are preserved', () async {
