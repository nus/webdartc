...
void registerVp9Codec() {
  CodecRegistry.registerVideoEncoder(VideoCodecName.vp9, Vp9EncoderBackend.new);
  CodecRegistry.registerVideoDecoder(VideoCodecName.vp9, Vp9DecoderBackend.new);
}
