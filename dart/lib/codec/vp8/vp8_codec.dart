...
void registerVp8Codec() {
  CodecRegistry.registerVideoEncoder(VideoCodecName.vp8, Vp8EncoderBackend.new);
  CodecRegistry.registerVideoDecoder(VideoCodecName.vp8, Vp8DecoderBackend.new);
}
